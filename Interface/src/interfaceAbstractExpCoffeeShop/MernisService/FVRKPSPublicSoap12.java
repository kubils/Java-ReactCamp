...
public class FVRKPSPublicSoap12
{
    ...
    public FVRKPSPublicSoap12(){}

    public FVRKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public FVRKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FVRExtendedSoapSerializationEnvelope envelope= new FVRExtendedSoapSerializationEnvelope(FVRExtendedSoapSerializationEnvelope.VER12);
