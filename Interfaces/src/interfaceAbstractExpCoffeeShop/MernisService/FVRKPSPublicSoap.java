package interfaceAbstractExpCoffeeShop.MernisService;
...
//https://github.com/torukobyte/JavaCampHomework/tree/master/MernisServiceEkleme
//----------------------------------------------------
...
public class FVRKPSPublicSoap
{
    interface FVRIWcfMethod
    {
        FVRExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(FVRExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public FVRKPSPublicSoap(){}

    public FVRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FVRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected FVRExtendedSoapSerializationEnvelope createEnvelope()
    {
        FVRExtendedSoapSerializationEnvelope envelope= new FVRExtendedSoapSerializationEnvelope(FVRExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,FVRExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,FVRExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new FVRIWcfMethod()
        {
            @Override
            public FVRExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                FVRExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(FVRExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(FVRIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        FVRExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,FVRExtendedSoapSerializationEnvelope envelope)
    {
