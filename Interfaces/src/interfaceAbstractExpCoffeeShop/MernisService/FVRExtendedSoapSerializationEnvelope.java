...
public class FVRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FVRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FVRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FVRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FVRDateTimeConverter dateTimeConverter = new FVRStandardDateTimeConverter();

    public FVRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FVRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FVRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FVRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FVRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FVRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
